...
<div class="container">
    <div id="homepage--cover" class="row">
        ...
        ?>
                                ...
                                <a class="categories col-xs-offset-1" href="<?php echo $term_url; ?>"><img src="<?php echo $flag_url;?>" alt="<?php echo $flag['alt'];?>"/ ><div><?php echo $term_name; ?> — <?php the_date('d.m.Y'); ?></div></a>
